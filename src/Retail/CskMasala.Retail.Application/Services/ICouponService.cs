...
public interface ICouponService
{
    ...
    Task<Guid> CreateCouponAsync(string code, DiscountType discountType, decimal discountValue, decimal minOrderAmount, int maxUsage, DateTime expiresAt, CancellationToken ct = default);
}
